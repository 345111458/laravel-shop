  ...
  <div class="card-body">
    ...
    <user-addresses-create-and-edit inline-template>
      ...
      <!-- 注意这里多了 @change -->
        ...
        <!-- 当组件中的值变化时，这里的值也会跟着变 -->
        <input type="hidden" name="province" v-model="province" value="{{ old('province', $address->province) }}">
        <input type="hidden" name="city" v-model="city" value="{{ old('city', $address->city) }}">
        <input type="hidden" name="district" v-model="district" value="{{ old('district', $address->district) }}">
        <div class="form-group row">
